    ...
    <div class="col-6">
        <div class="card">
            <div class="card-body">
                ...
                <?php endif; ?>
                <form action="<?= route_to('stock-in-material.store') ?>" method="post">
                    <?= csrf_field() ?>
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="mb-3">
                        ...
                        <div class="col-sm-12">
                            <div class="mb-3">
                                <label for="material_in">Material In</label>
                                <input id="material_in" name="material_in" type="number" min="0" class="form-control" placeholder="material_in" value="<?= old('material_in') ?>">
                            </div>
                        </div>
                        <div class="col-lg-12">
